...
function(data, options, cb) {
  ...
  } else if (allowExtendedOperators !== false && Model.settings.mongodb &&
    Model.settings.mongodb.hasOwnProperty('allowExtendedOperators')) {
    allowExtendedOperators = Model.settings.mongodb.allowExtendedOperators === true;
